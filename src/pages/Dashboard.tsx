...
const progressData = [
  { name: "Jan", Aulas: 3, Atividades: 2 },
  { name: "Fev", Aulas: 4, Atividades: 3 },
  { name: "Mar", Aulas: 6, Atividades: 4 },
  { name: "Abr", Aulas: 8, Atividades: 6 },
  { name: "Mai", Aulas: 7, Atividades: 5 },
  { name: "Jun", Aulas: 9, Atividades: 7 },
];
      ...
      <main className="flex-1 flex flex-col items-center px-2 md:px-6 py-4 w-full max-w-6xl mx-auto">
        ...
        <Card className="w-full mb-6">
          ...
          <CardContent>
            <ChartContainer 
              config={{
                Aulas: { theme: { light: "#2563eb", dark: "#3b82f6" } },
                Atividades: { theme: { light: "#10b981", dark: "#34d399" } },
              }} 
              className="h-72"
            >
              <AreaChart
